...
const CAMINHOS = {
  ...
  graph:
    'M9 2h6v4H9z M2 16h6v4H2z M16 16h6v4h-6z M11 6h2v2h-2z M9 8h2v2H9z M13 8h2v2h-2z M7 10h2v2H7z M15 10h2v2h-2z M5 12h2v2H5z M17 12h2v2h-2z M5 14h2v2H5z M17 14h2v2h-2z',
  heart:
