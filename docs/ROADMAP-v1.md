# Roadmap v1 (ARQUIVADO) — Serious Game de Estrutura de Dados

> **Este roadmap foi concluído** — todos os itens implementáveis
> autonomamente foram entregues e validados (ver PR #2). Fica arquivado
> como registro do que foi construído e por quê. A próxima fase do
> produto (plataforma empresarial de quiz, temas escolhidos pela empresa,
> montagem com IA e avaliação rica) está em [`ROADMAP.md`](./ROADMAP.md).
